...
const createFactory = require('../src/scripts/create-factory.coffee');
const init = require('../src/scripts/init.coffee');
const IndexTemplate = require('../views/index.coffee');
const Root = createFactory(require('../src/scripts/views/root.coffee'));

const RouterContext = createFactory(ReactRouter.RouterContext);

function renderTemplate(config) {
  const { lang, params, serverUrl, storeModule } = config;
